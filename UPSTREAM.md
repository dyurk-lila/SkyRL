...
_Last generated for `origin/main` (e17527a1) ↔ `HEAD` (8327e4fd); merge-base `7f453704`. **Auto-generated — do not edit by hand.**_

`develop` is **64 commit(s)** ahead of `main`.
...
```
 ...
 docs/content/docs/configuration/config.mdx         |    66 +-
 ...
 examples/train/async/async_trainer.py              |   141 +-
 ...
 .../train/fully_async/fully_async_run_gsm8k.sh     |     8 +-
 ...
 .../megatron/run_megatron_nemotron_mini_4b.sh      |     7 +-
 ...
 examples/train/sft/README.md                       |    19 +
 ...
 .../thunder_agent/scripts/r2egym_32b/setup_env.sh  |     2 +-
 ...
 .../skyrl_train/workers/worker_dispatch.py         |    69 +-
 skyrl/backends/skyrl_train/workers/worker_utils.py |    21 +-
 skyrl/backends/skyrl_train_backend.py              |   177 +-
 skyrl/benchmarks/bench_fused_linear_logprob.py     |   195 +
 skyrl/benchmarks/load_test_concurrency.py          |     1 -
 skyrl/env_vars.py                                  |    21 -
 skyrl/train/config/__init__.py                     |     4 +-
 skyrl/train/config/config.py                       |   272 +-
 skyrl/train/config/sft_config.py                   |    16 +
 skyrl/train/dataset/collators.py                   |   112 +-
 ...
 skyrl/train/fully_async_trainer.py                 |   356 +-
 ...
 skyrl/train/sft_trainer.py                         |   580 +-
 skyrl/train/trainer.py                             |   452 +-
 skyrl/train/utils/batch_prefetcher.py              |   102 +
 skyrl/train/utils/trainer_utils.py                 |    10 +-
 skyrl/train/utils/utils.py                         |    80 +-
 ...
 tests/train/test_config.py                         |   319 +-
 ...
 uv.lock                                            | 13473 +++++++++----------
 350 files changed, 23636 insertions(+), 17532 deletions(-)
```
