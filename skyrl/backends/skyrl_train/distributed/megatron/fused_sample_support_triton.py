"""Triton projection of irregular sample-support candidate pairs."""
...
def candidate_projection(
    ...
    if not TRITON_AVAILABLE or not hidden.is_cuda:
        raise RuntimeError("Triton sample-support projection requires Triton and CUDA")
